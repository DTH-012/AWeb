...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) vượt quá dung lượng cho phép <b>{maxSize} KB</b>.',
        ...
        msgInvalidFileExtension: 'File "{name}" có định dạng không hợp lệ. Định dạng đúng "{extensions}".',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
